...
<body class="hold-transition theme-dark bg-gradient-success">
                    ...
                    <div class="col-lg-4 col-md-5 col-12">
                        ...
                        <div class="p-30 rounded30 box-shadowed b-2 b-dashed">
                            ...
                            <div class="text-center">
                                <p class="mt-15 mb-0 text-white">Already Registered? <a href="{{ route('login') }}"
                                        class="btn btn-info btn-rounded ml-5 font-weight-bold text-uppercase">Login </a></p>
                            </div>
                        </div>
                    </div>
                </div>
