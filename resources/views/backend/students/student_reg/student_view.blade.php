                                                ...
                                                <div class="controls">
                                                    <select name="year_id" required="" class="form-control">
                                                        ...
                                                        @foreach ($years as $year)
                                                            <option value="{{ $year->id }}" {{-- The year must be equal to year ID --}}
                        ...
                        <div class="box">
                            ...
                            <div class="box-body">
                                <div class="table-responsive">
                                    ...
                                    {{-- If the search parameters is false  display as per the class ans year else perfom the search --}}
                                                ...
                                                @foreach ($allData as $key => $value)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a title="Promotion"
                                                                href="{{ route('promote.student', $value->student_id) }} "
                                                                class="btn btn-primary"><i class="fa fa-check"></i></a>
                                                            <a target="_blank" title="Details"
                                                                href="{{ route('generate.details.pdf', $value->student_id) }}"
