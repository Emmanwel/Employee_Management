                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="col">
                                ...
                                <form method="post" action="{{ route('update.student.promotion', $editData->student_id) }}"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <input type="text" name="lname" class="form-control"
                                                                required="" value="{{ $editData['student']['lname'] }}">
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="controls">
                                                            <select name="gender" id="gender" required=""
                                                                ...
                                                                <option value="Female"
                                                                    ...
                                                                    Female</option>
                                                                <option value="Female"
                                                                    {{ $editData['student']['gender'] == 'Others' ? 'selected' : '' }}>
                                                        ...
                                                        <div class="controls">
                                                            <select name="religion" id="religion" required=""
                                                                ...
                                                                <option value="Christian"
                                                                    ...
                                                                    Christian </option>
                                                                <option value="Pagan"
                                                                    {{ $editData['student']['religion'] == 'Pagan' ? 'selected' : '' }}>
                                                                    Pagan</option>
                                                                <option value="Muslim"
                                                                    {{ $editData['student']['religion'] == 'Muslim' ? 'selected' : '' }}>
                                                                    Muslim</option>
