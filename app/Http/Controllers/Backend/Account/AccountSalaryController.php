...
use App\Models\AccountsEmployeeSalary;
...
class AccountSalaryController extends Controller
{
    ...
    public function AddEditEmployeeAccountSalary()
    {

        return view('backend.accounts.employee_salary.employee_salary_add');
    } //End
    public function GetEmployeeAccountSalary(Request $request)
    {
        ...
        foreach ($data as $key => $attend) {
            ...
            $account_salary = AccountsEmployeeSalary::where('employee_id', $attend->employee_id)->where('date', $date)->first();
    ...
    public function StoreAccountSalary(Request $request)
    {
